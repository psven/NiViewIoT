...
#define FFMPEG_CONFIGURATION "--disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vdpau --disable-encoders --enable-encoder=png --enable-encoder=h264_videotoolbox --enable-encoder=hevc_videotoolbox --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h263 --enable-decoder=h263i --enable-decoder=h263p --enable-decoder=h264 --enable-decoder=h264_videotoolbox --enable-decoder='mp3*' --enable-decoder=vp6 --enable-decoder=vp6a --enable-decoder=vp6f --enable-decoder=hevc --enable-decoder=hevc_videotoolbox --enable-decoder=png --disable-hwaccels --disable-muxers --enable-muxer=mpegts --enable-muxer=mp4 --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=latm --enable-demuxer=live_flv --enable-demuxer=loas --enable-demuxer=m4v --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=hevc --enable-demuxer=h264 --enable-demuxer=image2 --enable-demuxer=image2pipe --enable-demuxer=image_png_pipe --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h263 --enable-parser=h264 --enable-parser=hevc --enable-parser=png --enable-bsfs --disable-bsf=mjpeg2jpeg --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=text2movsub --disable-bsf=eac3_core --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=unix --disable-devices --enable-filters --disable-iconv --enable-openssl --enable-protocol=crypto --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --prefix=/Users/jonor/Documents/SVN/git/ijkplayer/ios/build/ffmpeg-arm64/output --enable-openssl --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=9.0 -fembed-bitcode -I/Users/jonor/Documents/SVN/git/ijkplayer/ios/build/openssl-arm64/output/include' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=9.0 -fembed-bitcode -I/Users/jonor/Documents/SVN/git/ijkplayer/ios/build/openssl-arm64/output/include' --extra-ldflags=' -arch arm64 -miphoneos-version-min=9.0 -fembed-bitcode -arch arm64 -miphoneos-version-min=9.0 -fembed-bitcode -I/Users/jonor/Documents/SVN/git/ijkplayer/ios/build/openssl-arm64/output/include -L/Users/jonor/Documents/SVN/git/ijkplayer/ios/build/openssl-arm64/output/lib -lssl -lcrypto'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/jonor/Documents/SVN/git/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/jonor/Documents/SVN/git/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
